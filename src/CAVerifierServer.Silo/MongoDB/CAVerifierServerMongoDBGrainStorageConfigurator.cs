...
public class CAVerifierServerMongoDBGrainStorageConfigurator : IPostConfigureOptions<MongoDBGrainStorageOptions>
{
    private readonly IServiceProvider _serviceProvider;

    public CAVerifierServerMongoDBGrainStorageConfigurator(IServiceProvider serviceProvider)
    {
